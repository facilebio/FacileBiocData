...
**NOTE**: This package is incomplete. An alpha version should be available for
use in early March, 2020.
...
Once we've decorated the base Bioconductor assay container, we can use it
within the facile.bio ecosystem. For instance, we can now perform a differential
gene expression analysis using the `FacileAnalysis package.
